...
//TODO Put here the name of your currencyconst char CRYPTONOTE_NAME[] = "furiouscoin";
const char     CRYPTONOTE_NAME[]                             = "MelonHeads";
...
const int      P2P_DEFAULT_PORT                              = 4218;
//TODO This port will be used by the daemon to interact with simlewallet
const int      RPC_DEFAULT_PORT                              = 4217;
